...
export const metadata: Metadata = {
  ...
  title: {
    ...
    default: "DomesticHire — Find Trusted Domestic Workers in Zimbabwe",
  },
  description:
    "Browse verified profiles of maids, nannies, drivers, gardeners, cleaners, cooks, chefs, and nurse aides in Zimbabwe. Pay a one-time placement fee and get direct contact access. Simple, trusted, transparent.",
  keywords: [
    "domestic workers Zimbabwe",
    "hire maid Harare",
    "nanny Zimbabwe",
    "domestic helper",
    "gardeners Bulawayo",
