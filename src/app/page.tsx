      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto mb-10">
            Browse verified profiles, select your preferred worker, pay a one-time placement fee,
            and get direct contact access. Simple & transparent.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/about"
              className="inline-flex items-center justify-center gap-2 bg-white/10 text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/20 transition-colors text-lg border border-white/20"
            >
              How It Works
            </Link>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Browse", desc: "Explore worker profiles by category" },
              { step: "2", title: "Select", desc: "Pick your preferred helper" },
              { step: "3", title: "Pay", desc: "Pay a one-time placement fee" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-500 mt-1">Placements Monthly</div>
            </div>
            <div>
